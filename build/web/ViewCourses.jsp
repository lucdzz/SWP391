            ...
            <ul class="course-list">
                <c:forEach var="course" items="${courses}">
                    <li>
                        ...
                        <a href="updatecourse?courseCode=${course.courseCode}&semesterName=${semesterName}">Edit</a>
                        <a href="createclass?courseCode=${course.courseCode}&semesterName=${semesterName}">Add Class</a>
