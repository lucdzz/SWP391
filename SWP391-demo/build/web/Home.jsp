            ...
            <div class="functionality">
                <c:choose>
                    ...
                    <c:when test="${userType == 'Manager'}">
                        ...
                        <ul>
                            <li><a href="Semester.jsp">Create Semester</a></li>
                            <li><a href="create_course.jsp">Create Course</a></li>
                            <li><a href="create_class.jsp">Create Class</a></li>
                            <li><a href="assign_teacher.jsp">Add Teacher to Class</a></li>
                            <li><a href="view_quiz.jsp">View Quiz</a></li>
                        </ul>
                    </c:when>
