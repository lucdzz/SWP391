    ...
    <head>
        ...
        <style>
            * {
            ...
            .wrapper {
                width: 420px;
                background: #fff; /* Đổi nền khung thành màu trắng */
                border: 2px solid rgba(255, 255, 255, 1); /* Viền trắng */
            ...
            <form action="login" method="post">
                ...
                <div class="potentialidplist">
                    <div class="potentialidp">
                        <a href="https://accounts.google.com/o/oauth2/auth?scope=email profile openid&redirect_uri=http://localhost:9999/LoginGG/login&response_type=code&client_id=43254732211-6iii5ot47vio979uuri6vf3aopsm66go.apps.googleusercontent.com&approval_prompt=force" title="fpt.edu.vn" class="btn btn-secondary btn-block">
